...
def parse_args():
    ...
    parser.add_argument('--cts_bw_file', type=str, default="/gladstone/corces/lab/users/vishvak/chrombpnet_tutorial/pd_data/nd_Microglia_merge.normalized.bw",
    ...
    parser.add_argument('--project', type=str, default="cbpl_microglia",
    ...
    parser.add_argument('--valid_chrs', type=list, default=["chr10","chr11","chr12","chr13","chr14"],
    ...
    parser.add_argument('--use_attention_pooling',type=bool,default=False,
                        help='Use attention pooling or Global1D ')
